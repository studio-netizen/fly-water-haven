    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md p-8 bg-[#f5f0e8] border-none">
        ...
        <button
          ...
          className="w-full py-3 rounded-full text-sm font-medium border-[1.5px] border-[#242242]/15 bg-white text-[#242242] hover:opacity-85 transition-opacity flex items-center justify-center gap-2"
        >
